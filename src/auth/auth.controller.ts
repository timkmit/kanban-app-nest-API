...
export class AuthController {
  ...
  @Post('register')
  @ApiOperation({ summary: 'Register a new user', description: 'Registers a new user with a username, email, and password.' })
  ...
  @Post('login')
  @ApiOperation({ summary: 'Login', description: 'Logs in a user and returns an access token.' })
  @ApiBody({ type: LoginDto, description: 'Data required to login' })
  @ApiResponse({ status: 200, description: 'Successfully logged in and token returned.', type: LoginResponseDto })
